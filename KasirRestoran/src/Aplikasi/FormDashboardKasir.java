...
public class FormDashboardKasir extends JFrame {
    ...
    public FormDashboardKasir(int idUser, String username) {
        this.idUser = idUser;
        this.username = username;
        setTitle("Dashboard Kasir - " + username);
    ...
    private void initComponents() {
        ...
        JLabel lblRole = new JLabel("[ KASIR ]", SwingConstants.CENTER);
        ...
        String[] namaMenu = {"Dashboard", "Menu", "Pelanggan", "Input Pesanan"};
        ...
        contentArea.add(new PanelMenu(), "1");
        contentArea.add(new PanelPelanggan(), "2");
        contentArea.add(new PanelInputPesanan(idUser), "3");
    ...
    private int[] hitungData() {
        ...
        try {
            ...
            String[] query = {
                    ...
                    "SELECT COUNT(*) FROM pesanan WHERE id_user = " + idUser
            };
    ...
    private JPanel buatPanelDashboard() {
        ...
        JLabel sub = new JLabel("Gunakan menu di samping untuk mulai bekerja.");
        sub.setFont(new Font("Arial", Font.PLAIN, 13));
        sub.setForeground(new Color(100, 100, 100));
        sub.setBounds(30, 65, 500, 25);

        int[] jumlah = hitungData();

        String[] judul  = {"Menu", "Pelanggan", "Pesanan Saya"};
        String[] nilai  = {
                jumlah[0] + " Item",
                jumlah[1] + " Orang",
                jumlah[2] + " Transaksi"
        ...
        for (int i = 0; i < judul.length; i++) {
            ...
            card.setBounds(30 + i * 215, 110, 180, 140);
        ...
        JButton btn = new JButton() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (tipe == 0) {
                    ...
                    g2.setColor(PUTIH);
                    g2.setStroke(new BasicStroke(2f));
                    g2.drawLine(ix + 19, iy - 4, ix + 19, iy + 4);
                    g2.drawLine(ix + 15, iy,     ix + 23, iy);
                }
                g2.setColor(PUTIH);
